...
<head>
	<head>
	 	<meta charset="utf-8">
	 	<title>Dapo desina| Home Of Fashion</title>
...
<body>
	<div class="">
		<div id="box-wrapper">
			<img class="img-responsive pg_img" src="images/home_1.JPG" style="height: 635px; display: none; width: 100%;">
			<div class="button_mula_1">
				<table>
					<tbody>
						<tr>
							<td>
